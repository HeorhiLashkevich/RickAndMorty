...
public class LocationDetailsViewModel extends ViewModel {
    ...
    private void loadCurrentLocation(int id) {
        NetworkController.INSTANCE.getRickAndMortyApi().getLocationForDetails(id)
    ...
    private void loadCharactersFromLocation() {
        NetworkController.INSTANCE.getRickAndMortyApi().getMultiCharactersForLocationDetails(charactersUrlIds.getValue())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
