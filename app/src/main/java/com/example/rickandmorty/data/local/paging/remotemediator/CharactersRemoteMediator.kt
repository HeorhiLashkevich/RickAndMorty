...
//    private val database: AppCharactersDataBase,
//) : RemoteMediator<Int, CharactersEntity>() {
//
//    private val charactersDao = database.gerCharactersDao()
//   private val keyDao = database.gerPageKeyDao()
//
...
//            val characters = resBody?.results as List<CharactersEntity>
...
//                        it.page = loadKey
//                    }
//                    keyDao.insertOrReplace(PageKey(it.page, pageInfo?.next))
//                }
